-- KYC tier limits (server-side policy source) and break-glass admin overrides.
-- Apply after baseline schema (requires users table).
...
-- Seed baseline tiers (adjust in production via admin / DB).
